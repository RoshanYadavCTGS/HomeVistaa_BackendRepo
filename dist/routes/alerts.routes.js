...
router.use(auth_middleware_1.authenticate); // All alert routes require auth
router.get('/', alertsController.getAlerts);
router.post('/', (0, validate_middleware_1.validate)(inquiry_validator_1.createAlertSchema), alertsController.createAlert);
