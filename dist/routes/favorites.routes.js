...
const favoritesController = __importStar(require("../controllers/favorites.controller"));
const auth_middleware_1 = require("../middleware/auth.middleware");
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authenticate); // All favorites routes require auth
