    ...
    const properties = [
        {
            ...
            possessionDate: 'Ready to Move', possessionStatus: 'ready',
        ...
        },
        {
            ...
            possessionDate: 'Dec 2027', possessionStatus: 'under_construction',
        ...
        },
        {
            ...
            possessionDate: 'Mar 2026', possessionStatus: 'ready',
...
async function seedInteriors() {
    const designs = [
        { roomType: 'kitchen', title: 'The Italian Obsidian Kitchen', description: 'Deep charcoal matte modular drawers, integrated smart dishwasher drawers, built-in dual convection ovens, and gold-veined Calacatta marble countertops.', image: 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?auto=format&fit=crop&w=600&q=80', specsJson: ['Calacatta Marble', 'Charcoal Matte', 'Smart Integration', 'Soft Close'] },
        { roomType: 'kitchen', title: 'Minimalist Alabaster Galley', description: 'Streamlined handle-less overhead cabinets, hidden range hoods, warm under-cabinet LED setups, and seamless scratch-resistant white quartz surfaces.', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=600&q=80', specsJson: ['Quartz Tops', 'Under-cabinet LEDs', 'Push-to-open', 'Alabaster White'] },
        { roomType: 'bedroom', title: 'The Royal Velvet Suite', description: 'Double-height velvet tufted master headboards, integrated reading spotlights, custom floating bedside tables, and modular walk-in glass wardrobe units.', image: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=600&q=80', specsJson: ['Velvet Tufted', 'Glass Wardrobes', 'Floating Sideboards', 'Ambient Spotlight'] },
        { roomType: 'bedroom', title: 'Sleek Walnut Sanctuary', description: 'Rich walnut timber veneer backings, hidden floor-level wash-light strips, minimalist platform bed sets, and full-length bronzed privacy mirror modules.', image: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?auto=format&fit=crop&w=600&q=80', specsJson: ['Walnut Veneer', 'Platform Bed', 'Wash-light LEDs', 'Bronze Mirror'] },
        { roomType: 'living', title: 'Obsidian Sky Lounge Living', description: 'L-shaped premium mohair sofas, floating geometric entertainment consoles, brushed brass accent walls, and custom acoustic ceiling panelling.', image: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=600&q=80', specsJson: ['Mohair Fabric', 'Brass Accents', 'Acoustic Ceilings', 'Floating TV Unit'] },
        { roomType: 'living', title: 'Nordic Ivory Retreat', description: 'Clean Scandinavian-inspired white oak shelving, natural stone feature walls, sculptural pendant lighting, and cream bouclé accent chairs.', image: 'https://images.unsplash.com/photo-1567225477277-c8162eb8e073?auto=format&fit=crop&w=600&q=80', specsJson: ['White Oak', 'Stone Wall', 'Pendant Lighting', 'Bouclé Upholstery'] },
    ];
